...
"""
Exercise 3 (2018-11-14):
Take some text (can be few paragraphs) from Project Gutenberg and find the
5 most frequent characters and 5 most frequent words. Ignore all punctuation
and we recommend to lowercase the entire text.
Don't know if they are fully correct, but good practice :)
"""
